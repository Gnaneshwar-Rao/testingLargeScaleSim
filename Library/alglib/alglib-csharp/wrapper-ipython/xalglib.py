...
if curdir=="":
    curdir = "."
_net_candidates = []
_net_candidates.append(os.path.join(os.path.relpath(curdir),"alglib401gpl_net2.dll"))
_net_candidates.append(os.path.join(sys.prefix,"alglib401gpl_net2.dll"))
_net_candidates.append(os.path.join(os.sep+"usr","local","alglib401gpl_net2.dll"))
